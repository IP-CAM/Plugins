          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="type" id="input-status" class="form-control">
                <?php echo $type." - type"; ?>
                <?php if ($type == "img") { ?>
                <option value="img" selected="selected"><?php echo $entry_img; ?></option>
                <option value="video"><?php echo $entry_video; ?></option>
                <?php } else { ?>
                <option value="img"><?php echo $entry_img; ?></option>
                <option value="video" selected="selected"><?php echo $entry_video; ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
